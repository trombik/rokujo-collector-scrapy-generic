...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "<main>ヘディング<p>本文</p>神戸外国人居留地<p>本文2</p></main>",
            ["ヘディング", "本文", "神戸外国人居留地", "本文2"],
        ),
        (
        ...
        (
            '<main><p><hi rend="#b">明治維新</hi>（めいじいしん）とは、近代化改革である<hi rend="#sup">[1]</hi>。</p></main>', # noqa E501
            ["明治維新(めいじいしん)とは、近代化改革である。"] # noqa E501
        ),
        (
            "<main><p><hi>[注釈 1]</hi>は削除される</p></main>",
            ["は削除される"]
        ),
        (
            "<main><p>リストはアイテムごとに分割される。</p><list><item>アイテム1</item><item>アイテム2</item></list>", # noqa E501
            ["リストはアイテムごとに分割される。", "アイテム1", "アイテム2"]
        ),
    ],
)
